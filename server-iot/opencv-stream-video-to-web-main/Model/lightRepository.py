    ...
    def add_light_data(self, intensity, time_now):
        ...
        if conn:
            with conn:
                ...
                result=cursor.execute('INSERT INTO iot.lightsenor(Light_Intensity, Time) VALUES (%s, %s)', (intensity, time_now))
                conn.commit()
        ...
        try:
            ...
            if conn:
                with conn:
                    ...
                    cursor.execute('SELECT * FROM lightsenor WHERE deviceID = %s', (light_id,))
